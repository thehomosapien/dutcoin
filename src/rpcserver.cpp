...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "DUTCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DUTCOIN features */
        {"DUTCOIN", "masternode", &masternode, true, true, false},
        {"DUTCOIN", "listmasternodes", &listmasternodes, true, true, false},
        {"DUTCOIN", "getmasternodecount", &getmasternodecount, true, true, false},
        {"DUTCOIN", "masternodeconnect", &masternodeconnect, true, true, false},
        {"DUTCOIN", "masternodecurrent", &masternodecurrent, true, true, false},
        {"DUTCOIN", "masternodedebug", &masternodedebug, true, true, false},
        {"DUTCOIN", "startmasternode", &startmasternode, true, true, false},
        {"DUTCOIN", "createmasternodekey", &createmasternodekey, true, true, false},
        {"DUTCOIN", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"DUTCOIN", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"DUTCOIN", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"DUTCOIN", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"DUTCOIN", "getmasternodescores", &getmasternodescores, true, true, false},
        {"DUTCOIN", "mnbudget", &mnbudget, true, true, false},
        {"DUTCOIN", "preparebudget", &preparebudget, true, true, false},
        {"DUTCOIN", "submitbudget", &submitbudget, true, true, false},
        {"DUTCOIN", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"DUTCOIN", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"DUTCOIN", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"DUTCOIN", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"DUTCOIN", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"DUTCOIN", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"DUTCOIN", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"DUTCOIN", "checkbudgets", &checkbudgets, true, true, false},
        {"DUTCOIN", "mnsync", &mnsync, true, true, false},
        {"DUTCOIN", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> DUTCOIN-cli " + methodname + " " + args + "\n";
}
