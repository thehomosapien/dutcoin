...
#if defined(NDEBUG)
#error "DUTCOIN cannot be compiled without assertions."
#endif
...
#define REWARD_CUT_BLOCK 7752000
...
/** Fees smaller than this (in uDUT) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // DUT: We use certain sporks during IBD, so check to see if they are
