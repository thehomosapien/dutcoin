/* src/config/dutcoin-config.h.  Generated from dutcoin-config.h.in by configure.  */
/* src/config/dutcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "DUTCOIN"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DUTCOIN 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dutcoin"
