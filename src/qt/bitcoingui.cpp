                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DUT Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DUT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dutcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DUTCOIN"), this);
    aboutAction->setStatusTip(tr("Show information about DUTCOIN"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DUTCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DUT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DUT addresses"));
    ...
    openAction->setStatusTip(tr("Open a dutcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DUTCOIN help message to get a list with possible DUTCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DUTCOIN client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DUTCOIN network", "", count));
}
...
{
    QString strTitle = tr("DUTCOIN"); // default title
