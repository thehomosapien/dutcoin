...
/** Utility functions used by the DUTcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DUT addresses in monospace font
...
// Parse "dutcoin:" URI into recipient object, return true on successful parsing
