...
Intro
-----
DUTCOIN (DUT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. DUTCOIN utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run dutcoin-qt.exe.

DUTCOIN is the original DUTCOIN client and it builds the backbone of the network.
However, it downloads and stores the entire history of DUTCOIN transactions;
