...
#   c) node1 mines 32 blocks, so now node 0 has 500000DUT, node 1 has 4250DUT, node2 has none.
#   d) node0 sends 601 DUT to node2, in two transactions (301 DUT, then 300 DUT).
