Contributing to DUTCOIN
==================================

The DUTCOIN project operates an open contributor model where anyone is
...
The following applies to code changes to the DUTCOIN project, and is not to be
confused with overall DUTCOIN Network Protocol consensus changes.

Whether a pull request is merged into DUTCOIN rests with the project merge
...
Patches that change DUTCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the DUTCOIN consensus, it must have been
...
The project leader is the release manager for each DUTCOIN release.
